<script>
    ...
    const categories = fetch("http://localhost:9000/api/v1/category/main")
...
<div class="container pt-4 p-0">
    <div class="d-flex flex-row justify-content-center align-items-center gap-2">
        ...
        <div class="p-0" style="width:400px;">
            ...
            placeholder="상품명으로 검색" aria-label="Search" style="height:40px" 
            bind:this={keywordInput} on:keypress={search}>
        </div>
        <div class="p-0">
